...
class Food(Base):
    ...
    added_sugar_g_per_100g: Mapped[float] = mapped_column(Float, default=0.0, nullable=False)
    net_carbs_g_per_100g: Mapped[float] = mapped_column(Float, default=0.0, nullable=False)
    saturated_fat_g_per_100g: Mapped[float] = mapped_column(Float, default=0.0, nullable=False)
    trans_fat_g_per_100g: Mapped[float] = mapped_column(Float, default=0.0, nullable=False)
    monounsaturated_fat_g_per_100g: Mapped[float] = mapped_column(Float, default=0.0, nullable=False)
    polyunsaturated_fat_g_per_100g: Mapped[float] = mapped_column(Float, default=0.0, nullable=False)
    cholesterol_mg_per_100g: Mapped[float] = mapped_column(Float, default=0.0, nullable=False)
    sodium_mg_per_100g: Mapped[float] = mapped_column(Float, default=0.0, nullable=False)
    potassium_mg_per_100g: Mapped[float] = mapped_column(Float, default=0.0, nullable=False)
    magnesium_mg_per_100g: Mapped[float] = mapped_column(Float, default=0.0, nullable=False)
    phosphorus_mg_per_100g: Mapped[float] = mapped_column(Float, default=0.0, nullable=False)
    zinc_mg_per_100g: Mapped[float] = mapped_column(Float, default=0.0, nullable=False)
    ...
    vitamin_a_mcg_per_100g: Mapped[float] = mapped_column(Float, default=0.0, nullable=False)
    vitamin_c_mg_per_100g: Mapped[float] = mapped_column(Float, default=0.0, nullable=False)
    vitamin_d_mcg_per_100g: Mapped[float] = mapped_column(Float, default=0.0, nullable=False)
    vitamin_b12_mcg_per_100g: Mapped[float] = mapped_column(Float, default=0.0, nullable=False)
    folate_mcg_per_100g: Mapped[float] = mapped_column(Float, default=0.0, nullable=False)
